...
@test "ramalama pull ollama" {
    ...
    run_ramalama list
    is "$output" ".*ollama://library/smollm:135m" "image was pulled from ollama"
...
@test "ramalama pull ollama cache" {
    ...
    ollama serve &
    sleep 3
    (for i in $(seq 0 9); do ollama pull tinyllama && exit 0; done; ollama pull tinyllama)
    run_ramalama pull ollama://tinyllama
    run_ramalama rm ollama://tinyllama
    ollama rm tinyllama

    (for i in $(seq 0 9); do ollama pull smollm:135m && exit 0; done; ollama pull smollm:135m)
    run_ramalama pull https://ollama.com/library/smollm:135m
    run_ramalama list
    is "$output" ".*ollama://library/smollm:135m" "image was actually pulled locally from ollama cache"

    (for i in $(seq 0 9); do ollama pull smollm:360m && exit 0; done; ollama pull smollm:360m)
    RAMALAMA_TRANSPORT=ollama run_ramalama pull smollm:360m
    run_ramalama pull ollama://smollm:360m
    run_ramalama list
